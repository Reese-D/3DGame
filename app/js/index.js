...
function init() {
    ...
    var eyeTex = new THREE.TextureLoader().load("js/textures/eye3.png", THREE.SphericalRefractionMapping);
    //var eyeTex = new THREE.TextureLoader().load("js/textures/eye2.png", THREE.SphericalRefractionMapping);
